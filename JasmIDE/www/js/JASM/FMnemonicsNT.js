...
function RegAndDisposeAddressConverter()
{
	...
	this.checkIfDataIsLabel = function(addressDispose, programEnvironment) {
	...
	this.getValueFromAddress = function(addressMembers, programEnvironment) {
		...
		if(this.checkIfDisposeIsLabel(addressDispose, programEnvironment)) throw new FMErrorException("Dispose cannot be a label.");
		if(this.checkIfDataIsLabel(addressDispose, programEnvironment)) throw new FMErrorException("Register cannot be a label.");
